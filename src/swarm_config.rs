...
use libp2p::{gossipsub::IdentTopic, identity::Keypair, request_response::{cbor, ProtocolSupport}, Multiaddr, PeerId, StreamProtocol, Swarm, SwarmBuilder};

use crate::handlers::structures::{CustomBehav, Req, Res};

pub async fn new_swarm() -> (Swarm<CustomBehav>, PeerId){
